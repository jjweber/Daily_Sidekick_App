	...
	$.fn.extend({
		...
		function setMonthly(month, year) {
			...
			$(parent + " .monthly-header-title").html(
				...
				+ (settingCurrentMonth ? "" : '<a href="#" id="rightHeaderControl" class="monthly-reset"></a>'));
		...
		function viewToggleButton() {
			if($(parent + " .monthly-event-list").is(":visible")) {
				...
				$(parent + " .monthly-header-title").prepend('<a href="#" id="leftHeaderControl" class="monthly-cal"></a>');
			}
		}
